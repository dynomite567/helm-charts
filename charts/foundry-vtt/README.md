...
**Cloned from [hugoprudente/charts](https://github.com/hugoprudente/charts)**
...
```bash
$ helm repo add foundry-vtt https://dynomite567.github.io/helm-charts/
```
